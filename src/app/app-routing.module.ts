...
},
{
  ...
  {
    path: 'user-rol',
    loadChildren: () => import('./Pages/Secure/user-rol/user-rol.module').then( m => m.UserRolPageModule)
  },
  {
  ...
  {
    path: 'info-client',
    loadChildren: () => import('./Pages/Secure/info-client/info-client.module').then( m => m.InfoClientPageModule)
  },
  {
    path: 'edit-info-client',
    loadChildren: () => import('./Pages/Secure/edit-info-client/edit-info-client.module').then( m => m.EditInfoClientPageModule)
  },
  {
    path: 'credentials-info',
    loadChildren: () => import('./Pages/Secure/credentials-info/credentials-info.module').then( m => m.CredentialsInfoPageModule)
  },
  {
    path: 'edit-credentials-info',
    loadChildren: () => import('./Pages/Secure/edit-credentials-info/edit-credentials-info.module').then( m => m.EditCredentialsInfoPageModule)
  },
  {
    path: 'sports-group',
    loadChildren: () => import('./Pages/Secure/sports-group/sports-group.module').then( m => m.SportsGroupPageModule)
  },
  {
    path: 'edit-sports-group',
    loadChildren: () => import('./Pages/Secure/edit-sports-group/edit-sports-group.module').then( m => m.EditSportsGroupPageModule)
  },
  {
    path: 'group-stage',
    loadChildren: () => import('./Pages/Secure/group-stage/group-stage.module').then( m => m.GroupStagePageModule)
  },
  {
    path: 'avaliable-dates',
    loadChildren: () => import('./Pages/Secure/avaliable-dates/avaliable-dates.module').then( m => m.AvaliableDatesPageModule)
  },
  {
    path: 'edit-avaliable-dates',
    loadChildren: () => import('./Pages/Secure/edit-avaliable-dates/edit-avaliable-dates.module').then( m => m.EditAvaliableDatesPageModule)
  },
  {
    path: 'teamplayer',
    loadChildren: () => import('./Pages/Secure/teamplayer/teamplayer.module').then( m => m.TeamplayerPageModule)
  },
  {
    path: 'edit-teamplayer',
    loadChildren: () => import('./Pages/Secure/edit-teamplayer/edit-teamplayer.module').then( m => m.EditTeamplayerPageModule)
  },
  {
    path: 'court',
    loadChildren: () => import('./Pages/Secure/court/court.module').then( m => m.CourtPageModule)
  },
  {
    path: 'edit-court',
    loadChildren: () => import('./Pages/Secure/edit-court/edit-court.module').then( m => m.EditCourtPageModule)
  },
  {
    path: 'matches',
    loadChildren: () => import('./Pages/Secure/matches/matches.module').then( m => m.MatchesPageModule)
  },
  {
    path: 'edit-matches',
    loadChildren: () => import('./Pages/Secure/edit-matches/edit-matches.module').then( m => m.EditMatchesPageModule)
  },
  {
    path: 'info-matches-general',
    loadChildren: () => import('./Pages/Secure/info-matches-general/info-matches-general.module').then( m => m.InfoMatchesGeneralPageModule)
  },
  {
    path: 'vocalia-sheet',
    loadChildren: () => import('./Pages/Secure/vocalia-sheet/vocalia-sheet.module').then( m => m.VocaliaSheetPageModule)
  },
  {
